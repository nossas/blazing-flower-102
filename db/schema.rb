...
ActiveRecord::Schema.define(:version => 20110722165710) do
  ...
  add_index "comments", ["commentable_id", "commentable_type"], :name => "index_comments_on_commentable_id_and_commentable_type", :unique => true
