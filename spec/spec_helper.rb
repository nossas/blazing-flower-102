...
RSpec.configure do |config|
  ...
  config.filter_run_excluding no_hudson: true
...
{"rss"=>{"channel"=>{"title"=>"Yahoo! Weather - Rio de Janeiro, BR", "link"=>"http://us.rd.yahoo.com/dailynews/rss/weather/Rio_de_Janeiro__BR/*http://weather.yahoo.com/forecast/BRXX0201_c.html", "description"=>"Yahoo! Weather for Rio de Janeiro, BR", "language"=>"en-us", "lastBuildDate"=>"Thu, 25 Aug 2011 5:00 pm LST", "ttl"=>"60", "location"=>{"city"=>"Rio de Janeiro", "region"=>"RJ", "country"=>"Brazil"}, "units"=>{"temperature"=>"C", "distance"=>"km", "pressure"=>"mb", "speed"=>"km/h"}, "wind"=>{"chill"=>"24", "direction"=>"170", "speed"=>"11.27"}, "atmosphere"=>{"humidity"=>"83", "visibility"=>"9.99", "pressure"=>"1015.92", "rising"=>"2"}, "astronomy"=>{"sunrise"=>"6:10 am", "sunset"=>"5:41 pm"}, "image"=>{"title"=>"Yahoo! Weather", "width"=>"142", "height"=>"18", "link"=>"http://weather.yahoo.com", "url"=>"http://l.yimg.com/a/i/brand/purplelogo//uh/us/news-wea.gif"}, "item"=>{"title"=>"Conditions for Rio de Janeiro, BR at 5:00 pm LST", "geo:lat"=>"-22.98", "geo:long"=>"-43.2", "link"=>"http://us.rd.yahoo.com/dailynews/rss/weather/Rio_de_Janeiro__BR/*http://weather.yahoo.com/forecast/BRXX0201_c.html", "pubDate"=>"Thu, 25 Aug 2011 5:00 pm LST", "condition"=>{"text"=>"Partly Cloudy", "code"=>"30", "temp"=>"24", "date"=>"Thu, 25 Aug 2011 5:00 pm LST"}, "description"=>"\n<img src=\"http://l.yimg.com/a/i/us/we/52/30.gif\"/><br />\n<b>Current Conditions:</b><br />\nPartly Cloudy, 24 C<BR />\n<BR /><b>Forecast:</b><BR />\nThu - Clear. High: 24 Low: 20<br />\nFri - Mostly Sunny. High: 24 Low: 20<br />\n<br />\n<a href=\"http://us.rd.yahoo.com/dailynews/rss/weather/Rio_de_Janeiro__BR/*http://weather.yahoo.com/forecast/BRXX0201_c.html\">Full Forecast at Yahoo! Weather</a><BR/><BR/>\n(provided by <a href=\"http://www.weather.com\" >The Weather Channel</a>)<br/>\n", "forecast"=>[{"day"=>"Thu", "date"=>"25 Aug 2011", "low"=>"20", "high"=>"24", "text"=>"Clear", "code"=>"31"}, {"day"=>"Fri", "date"=>"26 Aug 2011", "low"=>"20", "high"=>"24", "text"=>"Mostly Sunny", "code"=>"34"}], "guid"=>"BRXX0201_2011_08_26_7_00_LST"}}, "version"=>"2.0", "xmlns:yweather"=>"http://xml.weather.yahoo.com/ns/rss/1.0", "xmlns:geo"=>"http://www.w3.org/2003/01/geo/wgs84_pos#"}}


SHORTENED_WEATHER_VALID_API_RESPONSE =
{"title"=>"Yahoo! Weather - Rio de Janeiro, BR", "link"=>"http://us.rd.yahoo.com/dailynews/rss/weather/Rio_de_Janeiro__BR/*http://weather.yahoo.com/forecast/BRXX0201_c.html", "description"=>"Yahoo! Weather for Rio de Janeiro, BR", "language"=>"en-us", "lastBuildDate"=>"Thu, 25 Aug 2011 5:00 pm LST", "ttl"=>"60", "location"=>{"city"=>"Rio de Janeiro", "region"=>"RJ", "country"=>"Brazil"}, "units"=>{"temperature"=>"C", "distance"=>"km", "pressure"=>"mb", "speed"=>"km/h"}, "wind"=>{"chill"=>"24", "direction"=>"170", "speed"=>"11.27"}, "atmosphere"=>{"humidity"=>"83", "visibility"=>"9.99", "pressure"=>"1015.92", "rising"=>"2"}, "astronomy"=>{"sunrise"=>"6:10 am", "sunset"=>"5:41 pm"}, "image"=>{"title"=>"Yahoo! Weather", "width"=>"142", "height"=>"18", "link"=>"http://weather.yahoo.com", "url"=>"http://l.yimg.com/a/i/brand/purplelogo//uh/us/news-wea.gif"}, "item"=>{"title"=>"Conditions for Rio de Janeiro, BR at 5:00 pm LST", "geo:lat"=>"-22.98", "geo:long"=>"-43.2", "link"=>"http://us.rd.yahoo.com/dailynews/rss/weather/Rio_de_Janeiro__BR/*http://weather.yahoo.com/forecast/BRXX0201_c.html", "pubDate"=>"Thu, 25 Aug 2011 5:00 pm LST", "condition"=>{"text"=>"Partly Cloudy", "code"=>"30", "temp"=>"24", "date"=>"Thu, 25 Aug 2011 5:00 pm LST"}, "description"=>"\n<img src=\"http://l.yimg.com/a/i/us/we/52/30.gif\"/><br />\n<b>Current Conditions:</b><br />\nPartly Cloudy, 24 C<BR />\n<BR /><b>Forecast:</b><BR />\nThu - Clear. High: 24 Low: 20<br />\nFri - Mostly Sunny. High: 24 Low: 20<br />\n<br />\n<a href=\"http://us.rd.yahoo.com/dailynews/rss/weather/Rio_de_Janeiro__BR/*http://weather.yahoo.com/forecast/BRXX0201_c.html\">Full Forecast at Yahoo! Weather</a><BR/><BR/>\n(provided by <a href=\"http://www.weather.com\" >The Weather Channel</a>)<br/>\n", "forecast"=>[{"day"=>"Thu", "date"=>"25 Aug 2011", "low"=>"20", "high"=>"24", "text"=>"Clear", "code"=>"31"}, {"day"=>"Fri", "date"=>"26 Aug 2011", "low"=>"20", "high"=>"24", "text"=>"Mostly Sunny", "code"=>"34"}], "guid"=>"BRXX0201_2011_08_26_7_00_LST"}}
